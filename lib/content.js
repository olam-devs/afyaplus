...
const CONTENT = {
  ...
  booking: {
    sw: {
      ...
      success: (name, phone, service, price, payUrl) =>
        `*Miadi Yako Imepokewa!*\n\nJina: ${name}\nSimu: ${phone}\nHuduma: ${service}\nBei: ${price}\n\nTimu yetu itawasiliana nawe hivi karibuni baada ya kulipa.\n\nBonyeza hapa kulipa:\n${payUrl}`,
    ...
    en: {
      ...
      success: (name, phone, service, price, payUrl) =>
        `*Booking Confirmed!*\n\nName: ${name}\nPhone: ${phone}\nService: ${service}\nPrice: ${price}\n\nOur team will contact you shortly after you pay.\n\nClick here to pay:\n${payUrl}`,
      successFallback: (name, phone, service, price) =>
