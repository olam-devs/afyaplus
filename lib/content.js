...
const CONTENT = {
  ...
  booking: {
    sw: {
      askName: "Tafadhali andika *jina lako kamili*:\n\n_(Mfano: Amina Juma Hassan)_",
      askContactPhone: (name) =>
        `Asante *${name}*! Sasa andika *namba yako ya mawasiliano*:\n\nHii ndiyo namba timu ya Afya+ itakayotumia kukufikia.\n\n_(Mfano: 0712345678)_`,
      askPaymentPhone:
        "Sasa andika *namba yako ya malipo*:\n\nHii ndiyo namba itakayopokea ombi la USSD la kulipa.\n_(Zinazokubalika: M-Pesa, Airtel Money, Mixx by Yas, Halotel)_\n\n_(Mfano: 0712345678)_",
      invalidPhone: "Namba ya simu si sahihi. Tafadhali andika namba sahihi:\n\n_(Mfano: 0712345678)_",
      confirm: (name, contactPhone, paymentPhone, service, price) =>
        `*Thibitisha Miadi Yako*\n\nJina: ${name}\nSimu ya Mawasiliano: ${contactPhone}\nSimu ya Malipo: ${paymentPhone}\nHuduma: ${service}\nBei: ${price}\n\nThibitisha ili kuendelea:`,
      successUssd: (name, contactPhone, paymentPhone, service, price) =>
        `*Miadi Yako Imepokewa!*\n\nJina: ${name}\nSimu ya Mawasiliano: ${contactPhone}\nSimu ya Malipo: ${paymentPhone}\nHuduma: ${service}\nBei: ${price}\n\n📱 *Angalia simu yako sasa!*\nTumetuma ombi la malipo kwa *${paymentPhone}* — *ukubali USSD inayokuja kwenye simu yako*.\n\nTimu yetu itawasiliana nawe baada ya malipo kukamilika.`,
      successFallback: (name, contactPhone, paymentPhone, service, price) =>
    ...
    en: {
      askName: "Please type your *full name*:\n\n_(Example: Amina Juma Hassan)_",
      askContactPhone: (name) =>
        `Thank you *${name}*! Now enter your *contact number*:\n\nThis is the number the Afya+ team will use to reach you.\n\n_(Example: 0712345678)_`,
      askPaymentPhone:
        "Now enter your *payment number*:\n\nThis number will receive the USSD payment request.\n_(Accepted: M-Pesa, Airtel Money, Mixx by Yas, Halotel)_\n\n_(Example: 0712345678)_",
      invalidPhone: "Invalid phone number. Please enter a valid number:\n\n_(Example: 0712345678)_",
      confirm: (name, contactPhone, paymentPhone, service, price) =>
        `*Confirm Your Booking*\n\nName: ${name}\nContact Number: ${contactPhone}\nPayment Number: ${paymentPhone}\nService: ${service}\nPrice: ${price}\n\nConfirm to proceed:`,
      successUssd: (name, contactPhone, paymentPhone, service, price) =>
        `*Booking Confirmed!*\n\nName: ${name}\nContact Number: ${contactPhone}\nPayment Number: ${paymentPhone}\nService: ${service}\nPrice: ${price}\n\n📱 *Check your phone now!*\nWe sent a payment request to *${paymentPhone}* — *approve the incoming USSD prompt on your phone*.\n\nOur team will contact you once payment is complete.`,
      successFallback: (name, contactPhone, paymentPhone, service, price) =>
